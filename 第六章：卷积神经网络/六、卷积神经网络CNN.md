...
- 从边缘检测说起
  ...
  - ![垂直边缘检测](D:/study/文献pdf/灵光一现/ML/机器学习.assets/垂直边缘检测.png)
...
- 什么是卷积操作？
  ...
  - 直观的gif
    ...
    - ![卷积神经网络动图](D:/study/文献pdf/灵光一现/ML/机器学习.assets/卷积神经网络动图.gif)
    - 与前向传播对比，可以发现：第一层的输入神经元（像素点）并**不全部**参与输出神经元的计算，这是卷积神经网络和普通的神经网络的一大区别。因此前向传播的神经网络又被称为**全连接神经网络** 
    - ![CNN动图](D:/study/文献pdf/灵光一现/ML/机器学习.assets/CNN动图.gif)
...
- 什么是过滤器/卷积核？
  ...
  - ![卷积核](D:/study/文献pdf/灵光一现/ML/机器学习.assets/卷积核.jpg)
  - 需要什么样的卷积核？
...
- 填充(Padding)
  ...
  - ![padding](D:/study/文献pdf/灵光一现/ML/机器学习.assets/padding.png)
  - 如何填充？
...
- 三维卷积（RGB images）
  ...
  - 图例如下
    - ![RGB卷积](D:/study/文献pdf/灵光一现/ML/机器学习.assets/RGB卷积.png)
    - ![RGB卷积2](D:/study/文献pdf/灵光一现/ML/机器学习.assets/RGB卷积2.gif)
...
- 多个卷积核（Multiple filters）
  ...
  - ![多个卷积核](D:/study/文献pdf/灵光一现/ML/机器学习.assets/多个卷积核.png)
...
- 一层卷积神经网络
  ...
  - 一个例子
    - ![一层CNN的例子](D:/study/文献pdf/灵光一现/ML/机器学习.assets/一层CNN的例子.png)
...
- 池化层（Pooling layer）
  - What？
    ...
    - 例子![Pooling](D:/study/文献pdf/灵光一现/ML/机器学习.assets/Pooling.png)
...
- 手写数字识别的例子
- ![一个完整的CNN](D:/study/文献pdf/灵光一现/ML/机器学习.assets/一个完整的CNN.png)
- 流程
  - 输入一个32x32x3的手写数字图片
...
- 流程中的参数变化
  - ![CNN中参数变化](D:/study/文献pdf/灵光一现/ML/机器学习.assets/CNN中参数变化.png)
...
- inception模块
  - ![inception模块](D:/study/文献pdf/灵光一现/ML/机器学习.assets/inception模块.png)
  - 思想：
  ...
  - 计算量问题
    ...
    - 如何减少计算量？
      ...
      - ![在inception中用1x1卷积](D:/study/文献pdf/灵光一现/ML/机器学习.assets/在inception中用1x1卷积.png)
- inception网络
  - 使用1x1卷积核减少计算量后的inception模块
    - ![inception网络模块](D:/study/文献pdf/灵光一现/ML/机器学习.assets/inception网络模块.png)
    - 如上图所示，对卷积操作先进行1x1卷积在进行nxn的卷积，而对池化层（相同卷积）操作后再进行1x1卷积都可以缩减信道。达到减少计算量的目的
  - 多个上述inception模块，构成inception网络
    - ![inception网络](D:/study/文献pdf/灵光一现/ML/机器学习.assets/inception网络.png)
...
- 数据扩充的方法
  ...
  - 色彩转换（color shifting）：对RGB三个通道加上不同的失真值
    - ![色彩转换png](D:/study/文献pdf/灵光一现/ML/机器学习.assets/色彩转换png.png)
    - PCA色彩扩充
  - 结合使用
